...
data_dir = '../01_Data/Single_Story/'
info_dir = '../02_Info/'
plot_dir = '../04_Charts/Single_Story/'
...
exp_info = pd.read_csv(f'{info_dir}Info_Single_Story.csv', index_col='Test_Name')
...
for f in data_file_ls:
    ...
    channel_list = pd.read_csv(info_dir+'Channel_list_Single_Story.csv', index_col='Channel_Name')
